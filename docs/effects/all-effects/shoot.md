...
- id: shoot
  args:
    ...
    projectile: arrow # The name of the projectile. You can see more projectiles from there https://hub.spigotmc.org/javadocs/bukkit/org/bukkit/entity/Projectile.html
